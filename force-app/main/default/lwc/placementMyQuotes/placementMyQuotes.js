...
export default class PlacementMyQuotes extends LightningElement {
        ...
        getQuoteRequest()
            .then(success => {
                try {
                    ...
                    this.allQuotesRequest = AllQuotes.filter(quote => quote.ownerName === this.currentUserName && quote.statusCase !== 'Apólice registrada');
                    this.valuesChart = AllQuotes.filter(quote => quote.ownerName === this.currentUserName && quote.statusCase !== 'Apólice registrada');
                    this.loaded = true;
